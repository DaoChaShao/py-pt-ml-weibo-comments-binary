...
**项目简介**
---
本项目旨在使用 **循环神经网络（RNN）** 对微博评论进行 **二分类**，将评论划分为正面和负面两类。项目基于 **PyTorch**
框架，实现数据预处理、模型训练、评估及预测流程。
...
- **模型构建**：基于 **RNN/LSTM/GRU** 的情感分类模型
- **模型训练**：支持批量训练、学习率调整及早停策略
- **模型评估**：准确率、F1-score 等指标
- **实践意义**：可用于微博舆情分析、情绪监控及社交媒体数据挖掘
