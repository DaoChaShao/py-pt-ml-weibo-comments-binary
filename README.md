...
**INTRODUCTION**
---
This project aims to perform **binary classification** on Weibo comments using **Recurrent Neural Networks (RNNs)**,
categorizing comments as either positive or negative. Built with **PyTorch**, it covers data preprocessing, model
training, evaluation, and prediction.

**DATA DESCRIPTION**
---

- **Number of samples**: ~119,988 Weibo comments
- **Fields**:
...
- **Data Preprocessing**: text cleaning, tokenization, word embedding
- **Model Construction**: sentiment classification with **RNN/LSTM/GRU**
- **Training**: supports batch training, learning rate scheduling, and early stopping
- **Evaluation**: metrics including accuracy and F1-score
- **Practical Application**: social media sentiment analysis, public opinion monitoring, and data mining
